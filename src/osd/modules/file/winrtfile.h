...
bool win_check_tty_path(std::string const &path);
osd_file::error win_open_tty(std::string const &path, std::uint32_t openflags, osd_file::ptr &file, std::uint64_t &filesize);
